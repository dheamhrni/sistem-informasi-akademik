...
<head>
	...
	<script src="./ajaxUpdateMhs.js"> //fungsi ini menginmpor file yang berisi ajaxUpdatemhs
		// function cetak(hal) {
		//   var xhttp;
		//   var dtcetak;	
...
require "fungsi.php";
require "head.html"; //memanggil html berisi sidebar
...
$jmlDataPerHal = 3; //variabel untuk membatasi jumlah data perhalaman
...
<div class="utama">
	...
	if ($kosong){
		...
		$no=$awalData+1; // kode ini untuk mendifinisikan variabel no untuk di gunakan sebagai nomor di tabel		
		while($row=mysqli_fetch_assoc($hasil)){ //loop ini untuk meloop semua record di tabel mhs yang ada di database
			?>	
			<tr>
				<td><?php echo $no?></td>
